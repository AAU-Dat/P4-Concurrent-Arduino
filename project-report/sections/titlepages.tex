...
\aautitlepage{%
  ...
  A usability test was planned, but due to a time constraint, the test was not conducted. Then Arcs language design and more are discussed, to display why certain descisions were made and what could have been done better. A conclusion of the project is then made, based on how well it solves the problem statement, and lives up to the learning goals of the semester.
