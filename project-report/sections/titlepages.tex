...
\aautitlepage{%
  ...
  This report aims to make a simple language for working concurrency on arduino for programming hobbists. Its entry point is what the existing solutions are, and describing what the problems with working concurrently with arduino are. Which culminates in the problem statement "To create a programming language for the Arduino with a set of con-
  currency constructs, that leverages the Protothreads library, to concisely
  ...
  A usability test was planned, but due to a time constraint, the test was not conducted.
 \todo[inline]{write about conclusion}
}
