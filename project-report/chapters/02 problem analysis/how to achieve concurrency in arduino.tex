...
\todo[inline]{Introduce the different programming languages}
...
\todo[inline]{Explain what the advantages and disadvantages of protothreads is relative to the our problem}
...
\todo[inline]{Introduce the different operative systems}
(Erika OS), FreeRTOS, Simba OS, TaskManagerIO



\todo[inline]{Is writing about the OS Erika relevant?} % move beneath ARTe
%\subsubsection{Erika}
