\chapter{Conclusion}\label{cha:conclusion}\todo{conclunsion needs an ending}
...
\question[inline]{Should the two sections be split up into sections, or should it all flow as one section?}
